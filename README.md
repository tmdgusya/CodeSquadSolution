...
U - 가장위를 왼쪽으로 한면 돌리기
U\` - 가장위를 오른쪽으로 한면 돌리기
D - 가장 아래쪽을 오른쪽으로 한면 돌리기
D\` - 가장 아래쪽을 왼쪽으로 한면돌리기
L - 가장 왼변을 아래쪽으로 한면돌리기
L\` - 가장 왼변을 윗쪽으로 한면 돌리기
R - 가장 오른쪽 변을 위쪽으로 한번 돌리기
R\` - 가장 오른쪽 변을 아랫쪽으로 한번 돌리기
F - 앞면을 시계방향으로 90도 회전
F\` - 앞면을 반시계 방향으로 90도 회전
B - 가장 뒷변을 반시계 방향으로 90도 회전
B` - 가장 뒷변을 시계 방향으로 90도 회전
